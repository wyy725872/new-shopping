window.onload=function(){
	...
	ajax("../json/choose_json.js",function(str){
		...
		for(var i=0;i<arr.phone.length;i++){	
				...
				div.className='ctdiv';
				div.innerHTML='<a href="detailed.php"><img class=\'ct_img\' src=\"images/'+arr.phone[i].img+'\"></a><p class=\"ct_p\">'+arr.phone[i].dec+'</p><span class=\"ct_span\">¥'+arr.phone[i].price+'</span><span class=\"ct_ping\">评论：('+arr.phone[i].ping+'）条</span><a href=\"#\"><img src="images/gouwuche.png"></a>';
				sw.appendChild(div);
		}
		/*有货无货*/
